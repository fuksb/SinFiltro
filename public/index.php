...
<head>
  ...
  <link rel="canonical" href="https://sinfiltros.es/" />
  ...
  <!-- TikTok / Instagram embed support -->
  <meta property="og:video"       content="https://sinfiltros.es/promo.mp4" />
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .share-section {
      position: relative; z-index: 10;
      max-width: 600px; margin: 0 auto 40px; padding: 0 24px;
    }
    .share-inner {
    ...
    .share-title i { color: var(--orange); }
    .share-buttons {
    ...
    .share-btn.twitter { background: #000; box-shadow: 0 4px 20px rgba(0,0,0,0.3); }
    .share-btn.whatsapp { background: #25D366; box-shadow: 0 4px 20px rgba(37,211,102,0.3); }
    .share-btn.linkedin { background: #0A66C2; box-shadow: 0 4px 20px rgba(10,102,194,0.3); }
    .share-btn.telegram { background: #0088CC; box-shadow: 0 4px 20px rgba(0,136,204,0.3); }
    .share-btn.copy { background: linear-gradient(135deg, var(--purple), var(--orange)); box-shadow: 0 4px 20px rgba(139,92,246,0.3); }
    ...
    .success-meta h4 { font-size: 0.95rem; font-weight: 700; color: white; }
    .success-meta span { font-size: 0.75rem; color: var(--muted); }
    .success-story {
    ...
    .success-savings i { font-size: 0.9rem; }
    ...
    .ticker-item i { color: var(--orange); font-size: 0.9rem; }
    .ticker-item span { font-size: 0.85rem; color: rgba(255,255,255,0.6); font-weight: 500; }
    ...
    .floating-btn.whatsapp-f { background: #25D366; }
    .floating-btn.telegram-f { background: #0088CC; }
    ...
    .urgency-strip i { color: #F87171; animation: urgencyPulse 1.5s ease-in-out infinite; }
...
<div class="hero">
  ...
  <div class="urgency-strip">
    ...
    <span><strong id="live-count"><?= rand(23, 47) ?></strong> personas analizando ahora mismo</span>
  </div>
  ...
  <div class="tools-grid">
    ...
    <a class="tool-card" href="coche.php" style="--card-accent:#8B5CF6;--card-glow:rgba(139,92,246,0.08);">
      <div class="card-top">
        ...
        <span class="tool-badge badge-new"><i class="fa fa-fire" style="margin-right:4px;"></i>Trending</span>
      </div>
      ...
      <div class="tool-footer">
        ...
        <div class="tool-stats"><i class="fa fa-users" style="margin-right:4px;"></i>12.4K usos</div>
      </div>
    </a>
    ...
    <a class="tool-card" href="hipoteca.php" style="--card-accent:#F97316;--card-glow:rgba(249,115,22,0.08);">
      <div class="card-top">
        ...
        <span class="tool-badge badge-new"><i class="fa fa-fire" style="margin-right:4px;"></i>Hot</span>
      </div>
      <div class="tool-content">
      ...
      <div class="tool-footer">
        ...
        <div class="tool-stats"><i class="fa fa-users" style="margin-right:4px;"></i>8.7K usos</div>
      </div>
    </a>
...
<div class="ticker-section">
  <div class="ticker-track">
    <div class="ticker-item"><i class="fa fa-check-circle"></i> <span>María G. ahorró <strong>4.200€</strong> en su coche gracias a SinFiltros</span></div>
    <div class="ticker-item"><i class="fa fa-check-circle"></i> <span>Carlos P. descubrió <strong>3 cláusulas abusivas</strong> en su hipoteca</span></div>
    <div class="ticker-item"><i class="fa fa-check-circle"></i> <span>Laura M. cambió de tarifa de luz y ahorra <strong>47€/mes</strong></span></div>
    <div class="ticker-item"><i class="fa fa-check-circle"></i> <span>Pedro R. evitó una estafa de <strong>8.500€</strong> en un coche de segunda mano</span></div>
    <div class="ticker-item"><i class="fa fa-check-circle"></i> <span>Ana S. redujo su póliza <strong>320€/año</strong> eliminando coberturas inútiles</span></div>
    <div class="ticker-item"><i class="fa fa-check-circle"></i> <span>Roberto L. ahorró <strong>12.000€</strong> en comisiones de su fondo de inversión</span></div>
...
<div class="success-section">
  <h2 class="success-title">Historias de <em>ahorro real</em></h2>
  <p class="success-subtitle">Personas como tú que descubrieron lo que les ocultaban</p>
  <div class="success-grid">
    <div class="success-card" style="position:relative;">
      <div class="trending-badge"><i class="fa fa-fire"></i> Viral</div>
      <div class="success-header">
        <div class="success-avatar">MG</div>
        <div class="success-meta">
          <h4>María G.</h4>
          <span>Madrid · Coche de segunda mano</span>
        </div>
      </div>
      <p class="success-story">"El vendedor me decía que el coche estaba perfectamente. SinFiltros detectó que el kilometraje había sido manipulado y que tenía un accidente no declarado. Me ahorré 4.200€."</p>
      <div class="success-savings"><i class="fa fa-piggy-bank"></i> 4.200€ ahorrados</div>
    </div>
    <div class="success-card">
      <div class="success-header">
        <div class="success-avatar">CP</div>
        <div class="success-meta">
          <h4>Carlos P.</h4>
          <span>Barcelona · Hipoteca</span>
        </div>
      </div>
      <p class="success-story">"Mi banco me ofrecía una hipoteca 'del 3,4%'. SinFiltros me mostró que con los seguros vinculados el TAE real era del 5,2%. Negocié y me quité 2 vinculaciones."</p>
      <div class="success-savings"><i class="fa fa-piggy-bank"></i> 18.000€ en 30 años</div>
    </div>
    <div class="success-card">
      <div class="success-header">
        <div class="success-avatar">LM</div>
        <div class="success-meta">
          <h4>Laura M.</h4>
          <span>Valencia · Tarifa de luz</span>
        </div>
      </div>
      <p class="success-story">"Llevaba 3 años con la PVPC pagando de más. SinFiltros me recomendó una tarifa fija según mi consumo. Ahora pago 47€ menos al mes sin cambiar nada más."</p>
      <div class="success-savings"><i class="fa fa-piggy-bank"></i> 564€/año</div>
    </div>
  </div>
</div>
...
<div class="share-section">
  <div class="share-inner">
    <div class="share-title"><i class="fa fa-share-nodes"></i> ¿Te ha servido? Compártelo</div>
...
<div class="media-section">
  <div class="media-label">Mencionado en</div>
  <div class="media-logos">
    <span class="media-logo">Xataka</span>
    <span class="media-logo">El Confidencial</span>
    <span class="media-logo">Business Insider</span>
    <span class="media-logo">20minutos</span>
    <span class="media-logo">Genbeta</span>
  </div>
</div>

<!-- FLOATING CTA -->
<div class="floating-cta" id="floating-cta">
  <a href="https://t.me/sinfiltros_es" target="_blank" rel="noopener" class="floating-btn telegram-f" title="Únete a Telegram">
    <i class="fa-brands fa-telegram"></i>
  </a>
  <a href="https://wa.me/?text=<?= urlencode('¡Mira esta herramienta! SinFiltros te analiza coches, hipotecas y más en 15 segundos. https://sinfiltros.es') ?>" target="_blank" rel="noopener" class="floating-btn whatsapp-f" title="Compartir en WhatsApp">
    <i class="fa-brands fa-whatsapp"></i>
  </a>
  <a href="coche.php" class="floating-btn main" title="Analizar un coche">
    <i class="fa fa-car-side"></i>
  </a>
</div>

<!-- TOAST -->
<div class="toast" id="toast"><i class="fa fa-check-circle"></i> <span id="toast-msg">¡Enlace copiado!</span></div>
...
<script>
  ...
  // ── VIRAL FEATURES ──
  const shareUrl = 'https://sinfiltros.es';
  const shareText = '¡Esta IA te dice lo que las empresas te ocultan! Coches, hipotecas, luz... analizados sin filtros en 15 segundos.';
  ...
  function triggerConfetti() {
    const colors = ['#8B5CF6', '#F97316', '#10B981', '#06B6D4', '#EC4899'];
  ...
  function animateCounter() {
    ...
    setInterval(() => {
      ...
      const newVal = Math.max(15, Math.min(60, current + change));
