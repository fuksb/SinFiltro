...
if ($isUrl) {
    ...
    if ($fetched && strlen($fetched) > 250) {
        ...
        echo json_encode([
            'error'            => 'No se pudo leer el contenido del enlace automáticamente. Esta web puede cargar con JavaScript. Copia el texto de las condiciones y pégalo directamente aquí.',
...

{
  ...
  "comparativa": {
    "vs_mercado": "[Prima X€ vs mercado Y€. Compañías: Generali/Mapfre/Mutua a Z€/año]",
    "alternativas": "[Nombra 2-3 compañías concretas con precios orientativos]",
